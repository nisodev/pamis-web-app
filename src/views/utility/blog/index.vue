<template>
  <div class="lg:flex flex-wrap blog-posts lg:space-x-5 space-y-5 lg:space-y-0">
    <div class="flex-none">
    ...
    <div class="flex-1">
      <div class="grid xl:grid-cols-2 grid-cols-1 gap-5">
        <div class="xl:col-span-2 col-span-1">
          <Card :img="require('@/assets/images/all-img/post-1.png')">
              ...
              <router-link :to="{ name: 'blog-details' }"
                ><span
                  ...
                  ><Icon
                    ...
                    class="text-slate-400 dark:text-slate-400 mr-2 text-lg"
                  />
        ...
        <Card
          :img="require('@/assets/images/all-img/post-1.png')"
          imgTop
          gapNull
        >
          <div class="flex justify-between mb-4">
